defmodule TodoServer do
  ...
  def add_entry(entry) do
    ServerProcess.cast(TodoServer, {:add_entry, entry})
  end

  def remove_entry(id) do
    ServerProcess.cast(TodoServer, {:remove_entry, id})
  end

  def list_entries(date) do
    ServerProcess.call(TodoServer, {:list, date})
  end

  # ServerProcess callback implementations
  def init do
    TodoList.new()
  end
